...
public class GeoLocationService
{
	...
	public static void main(final String[] args)
	{
		...
		for (Point point : getExtremePointsFrom(ludwigsburg, 300.00))
		{
			...
			System.out
				.println("Distance from point  : "
					+ DistanceCalculator.distanceBetweenPoints(ludwigsburg, point,
						MeasuringUnit.METER));
		}
	 ...
	 */
	public static double getDistanceBetweenPoints(final Point p1, final Point p2,
			final String unit) {
